  ...
  return (
    <div className="home-container min-h-screen bg-light-background dark:bg-dark-background text-light-text dark:text-dark-text">
      ...
      <div className="max-w-screen-xl mx-auto p-8 pt-16">
        ...
        >
          <h1 className="text-4xl font-bold mb-4 text-center mt-10 pb-8">Bienvenue sur mon Portfolio !</h1>
        </motion.p>
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start">
          ...
          >
            ...
            <div className="mt-4 text-left space-y-3">
              <p>🎉 <span className="font-semibold text-yellow-400">Gagnant du 1er prix</span> au <a className="underline" href="https://www.mangadraft.com/contests/mangadraft-x-xp-pen-2022.fr"> Concours Mangadraft x XPPen 2022</a> (avec la participation de <span className="text-red-400 underline"><a href="https://www.mangas.io/">Manga-io</a></span> et <span className="text-green-400 underline"><a href="https://www.xp-pen.fr/">XP PEN</a></span>).</p>
